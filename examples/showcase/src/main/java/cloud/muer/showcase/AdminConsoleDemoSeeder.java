...
import static cloud.muer.showcase.AdminDemoSeedConstants.ADMIN_PERMISSIONS;
import static cloud.muer.showcase.AdminDemoSeedConstants.PERMISSION_ID_BASE;
 ...
 * profile AND {@code muer.showcase.seed-admin=true} are active; production and
 * ordinary dev never create the account. No default admin/password is ever
 * auto-provisioned.
 */
@Component
@Profile("dev")
@ConditionalOnProperty(prefix = "muer.showcase", name = "seed-admin", havingValue = "true")
