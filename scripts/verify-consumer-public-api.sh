...
source_root="${1:-$script_dir/../test-apps/consumer-acceptance/src/main/java}"
...
# internal/impl implementation packages under cloud.muer are off-limits.
forbidden_pattern='^[[:space:]]*import[[:space:]]+cloud\.muer\.([a-z][a-zA-Z]*\.)*(internal|impl|persistence)(\.|;)'
