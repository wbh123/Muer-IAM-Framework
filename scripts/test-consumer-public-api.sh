...
printf '%s\n' 'import cloud.muer.session.internal.Secret;' > "$sandbox/src/main/java/example/Illegal.java"
...
printf '%s\n' 'import cloud.muer.authentication.IdentityAuthenticator;' > "$sandbox/src/main/java/example/Legal.java"
