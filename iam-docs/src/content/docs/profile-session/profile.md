...
- `AuthorizationProfile`：https://github.com/wbh123/iam/blob/main/iam-authorization/src/main/java/io/github/iamstarter/authorization/
...
- 演示种子：`iam-example/src/main/java/io/github/iamstarter/example/`
