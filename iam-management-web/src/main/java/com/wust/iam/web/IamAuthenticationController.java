...
import com.wust.iam.web.api.AuthenticationApi;
import com.wust.iam.web.dto.LoginResponse;
import com.wust.iam.web.dto.PrincipalResponse;
...
public class IamAuthenticationController implements AuthenticationApi {
    ...
    @Override
    public ResponseEntity<LoginResponse> login(com.wust.iam.web.dto.LoginRequest request) {
        var servletRequest = currentServletRequest();
        var result = authentication.login(new com.wust.iam.authentication.LoginRequest(
