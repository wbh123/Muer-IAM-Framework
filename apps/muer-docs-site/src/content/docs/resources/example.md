...
`examples/showcase` 的 `ExampleIdentityAdapter` 提供：
...
## Seeder 数据（QuickStartDemoSeeder，dev + muer.showcase.seed-demo=true）
...
- 演示：<https://github.com/wbh123/Muer-IAM-Framework/blob/main/examples/showcase/src/main/java/cloud/muer/showcase/>
