...
源码见 [muer-session](https://github.com/wbh123/Muer-IAM-Framework/blob/main/muer-session/src/main/java/cloud/muer/session/)。`touch` 受 `muer.session.touch-interval`（默认 10m）节流。
